...
public interface CategoriaRepository extends JpaRepository<Categoria, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO categoria (nombre, descripcion, caracteristicasAlmacenamiento) VALUES (CATEGORIA_CATEGORIA_ID_SEQ.nextval, :nombre, :descripcion, :caracteristicasAlmacenamiento)", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE categoria SET nombre = :nombre, descripcion = :descripcion, caracteristicasAlmacenamiento = :caracteristicasAlmacenamiento WHERE id = :id", nativeQuery = true)
