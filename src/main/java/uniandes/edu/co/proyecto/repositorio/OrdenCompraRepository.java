...
//inicialización de cada atributo dentro del sistema
    ...
    void insertarOrdenCompra(@Param("precio") BigDecimal precio, @Param("fechaEntrega") Date fechaEntrega, @Param("proveedor_id") Integer proveedor_id, @Param("sucursal_id") Integer sucursal_id);
